...
public class ViewNhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnExit);
        btnExit.setBounds(0, 300, 140, 60);
        ...
        btnThongKe.setBounds(0, 180, 140, 60);
        ...
        btnKhachHang.setBounds(0, 240, 140, 60);
    ...
    private void btnVoucherMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVoucherMouseClicked
     ...
     if(user.getIdCV()==1){
        ...
        for (JButton btn11 : btn1) {
         ...
         JOptionPane.showMessageDialog(rootPane, "ban dang dang nhap voi tai khoan nhan vien");
     }
